...
enter_explore_mode(VOID_ARGS)
{
    if (wizard) {
        ...
        You("can't enter explore mode, it is disabled.");
    }
    return 0;
}
...
struct ext_func_tab extcmdlist[] = {
    ...
    { '\0', "curse", "curse an enemy team", docurse, IFBURIED | AUTOCOMPLETE },
    { '\0', "wish", "grant a wish for your team", doteamwish, IFBURIED | AUTOCOMPLETE },
#ifdef DEBUG
