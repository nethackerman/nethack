...
NEARDATA struct permonst mons[] = {
    ...
    MON("giant rat", S_RODENT, LVL(1, 10, 7, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        CLR_BROWN),
    MON("kebabdjur", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_DRCO, 2, 4), ATTK(AT_SPIT, AD_SAUS, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 250, MS_SQEEK, MZ_HUGE), MR_POISON, 0,
...
struct permonst _mons2[] = {
    ...
    MON("Oracle", S_HUMAN, LVL(20, 0, 0, 50, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_NONE, AD_MAGM, 16, 32), ATTK(AT_KICK, AD_PHYS, 16, 32), ATTK(AT_KICK, AD_PHYS, 16, 32), ATTK(AT_KICK, AD_PHYS, 16, 32), NO_ATTK,
          NO_ATTK),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("mail daemon", S_DEMON, LVL(56, 24, 10, 127, 0),
        ...
        CLR_BRIGHT_BLUE),
#endif
    MON("DHL delivery man", S_HUMAN, LVL(56, 24, 80, 127, 0),
        (G_NOGEN | G_NOCORPSE),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SILENT, MZ_HUMAN),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE, 0,
